...
import audienceQuestions from "./audience-questions.png?w=800&format=webp&imagetools";
import faceCam from "./face-cam.png?w=800&format=webp&imagetools";
import hardware2 from "./hardware-2.jpg?w=800&format=webp&imagetools";
import hardware from "./hardware.png?w=800&format=webp&imagetools";
import itempool from "./itempool.png?w=800&format=webp&imagetools";
import liveQuiz from "./live-quiz.png?w=800&format=webp&imagetools";
import overhead from "./overhead.png?w=800&format=webp&imagetools";
import screenCapture from "./screen-capture.png?w=800&format=webp&imagetools";
import throughTheInternet from "./through-the-internet.png?w=800&format=webp&imagetools";

<section>

<img src={throughTheInternet} alt="" className="max-w-100 self-center" />
...
<Figure image={faceCam}>A simple face camera</Figure>
<Figure image={overhead}>
  An overhead shot of pen and paper where I wrote out the lesson.
</Figure>
<Figure image={screenCapture}>
  A screen capture used to show animations, graphs on Desmos, and coding
  examples
</Figure>
<Figure image={audienceQuestions}>Questions from the audience</Figure>
<Figure image={liveQuiz}>The live quiz</Figure>
...
<Figure image={itempool} className="max-w-100 self-center" />
