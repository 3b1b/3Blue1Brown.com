...
description: Lessons learned from lockdown math
date: 2020-07-02
---

import Image from "~/components/Image";
import audienceQuestions from "./audience-questions.jpg?w=800&format=webp&imagetools";
import faceCam from "./face-cam.jpg?w=800&format=webp&imagetools";
import hardware2 from "./hardware-2.jpg?w=800&format=webp&imagetools";
import hardware from "./hardware.jpg?w=800&format=webp&imagetools";
import itempool from "./itempool.jpg?w=800&format=webp&imagetools";
import liveQuiz from "./live-quiz.jpg?w=800&format=webp&imagetools";
import overhead from "./overhead.jpg?w=800&format=webp&imagetools";
import screenCapture from "./screen-capture.jpg?w=800&format=webp&imagetools";
import throughTheInternet from "./through-the-internet.jpg?w=800&format=webp&imagetools";

<section>

<Image image={throughTheInternet} className="max-w-100 self-center" />
...
<Image image={faceCam}>A simple face camera</Image>
<Image image={overhead}>
  An overhead shot of pen and paper where I wrote out the lesson.
</Image>
<Image image={screenCapture}>
  A screen capture used to show animations, graphs on Desmos, and coding
  examples
</Image>
<Image image={audienceQuestions}>Questions from the audience</Image>
<Image image={liveQuiz}>The live quiz</Image>

</div>

In OBS you can set up keyboard shortcuts, so I set up a few to associate certain keys under the lefthand of my keyboard with different scenes so that I could switch between them easily, potentially even while writing or gesturing with my right hand under the overhead camera. It may not have been quite as seamless as real live TV with a production team orchestrating the feed, but I think it can get arbitrarily close with practice. The upshot is that the look and feel of a professional production is more accessible to an individual teacher than you might think.
...
<Image image={itempool} className="max-w-100 self-center" />
...
<Image image={hardware}>
  The masking tape on the desk was to know what region is inside the shot of the
  overhead cam, though even then I'd occasionally write off-screen. The sticky
  notes on the overhead camera rig let me know where to point in the air to
  reference links and things on the screen.
</Image>

<Image image={hardware2}>
  The microphone in this shot was just a backup in case the lav mic failed on us
  for some reason.
</Image>
