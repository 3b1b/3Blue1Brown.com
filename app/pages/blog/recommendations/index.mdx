...
<img src={brilliant} className="max-h-50 self-center" alt="" />
...
<img src={aops} className="max-h-50 self-center" alt="" />
...
<img src={mathigon} className="max-h-50 self-center" alt="" />
...
<img src={khan} className="max-h-50 self-center" alt="" />
