...
{/* side-by-side demo page for all site-wide /components */}
...
<Figure
  ...
  video="https://upload.wikimedia.org/wikipedia/commons/6/67/Trefoil_knot.webm?utm_source=commons.wikimedia.org&utm_campaign=index&utm_content=original"
  show="video"
>
...
<NumberBox label="Lorem ipsum" help="Yep, lorem ipsum" min={0} max={100} />
...
$$
\color{red}red\quad
\color{orange}orange\quad
\color{green}green\quad
\color{blue}blue\quad
\color{purple}purple\quad
\color{pink}pink\quad
\color{gray}gray
$$
