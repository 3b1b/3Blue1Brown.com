...
=
\begin{bmatrix}
\color{green}a\color{currentColor}x+\color{red}b\color{currentColor}y \\
\color{green}c\color{currentColor}x+\color{red}d\color{currentColor}y
\end{bmatrix}
$$
...
<Collapsible title="Numerical Proof">
...
<Collapsible title="Scaling Commutativity ">
