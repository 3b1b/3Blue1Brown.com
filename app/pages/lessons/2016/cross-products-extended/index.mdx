...
<Figure image="$lesson/figures/transformations/LinearTransformationVectorRelatedTo1x2Matrix.svg">
  Any time you have a 2d-to-1d linear transformation it's associated with some
  vector.
</Figure>
...
<Figure image="$lesson/figures/the-idea/ConectionBetweenGeometryAndComputation.svg" />
