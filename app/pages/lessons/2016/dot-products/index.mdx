...
<Figure image="$lesson/figures/geometric-interpretation/OrderDoesNotMatter.svg">
  Even though this feels like a very different process, it produces the same
  result.
</Figure>
...
<Figure image="$lesson/figures/geometric-interpretation/OrderDoesNotMatterSymmetryIsBrokenProjectedW.svg">
  The length of projecting $\mathbf{w}$ onto $2\mathbf{v}$ stays the same, while
  the length of $2\mathbf{v}$ doubles.
</Figure>
...
<Figure image="$lesson/figures/geometric-interpretation/OrderDoesNotMatterSymmetryIsBrokenProjected2V.svg">
  The length of projecting $2\mathbf{v}$ onto $\mathbf{w}$ doubles, while the
  length of $\mathbf{w}$ stays the same.
</Figure>
...
<Figure
  image="$lesson/figures/linear-transformations/NonLinearTransformation.png"
...
<Figure image="./figures/linear-transformations/LinearTransformationVectorToNumberQuestion1Answer.svg" />
