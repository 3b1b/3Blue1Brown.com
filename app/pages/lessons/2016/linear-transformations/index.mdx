...
<PiCreature emotion="speaking">Transformation" suggests movement!</PiCreature>
...
<Figure
  image="$lesson/figures/transformations-are-functions/ex_parabola.png"
  video="$lesson/figures/transformations-are-functions/ex_parabola.mp4"
/>

<Figure
  image="$lesson/figures/transformations-are-functions/ex_circle.png"
...
<Figure image="$lesson/figures/what-makes-a-transformation-linear/LinesRemainLinesAndOriginRemainsFixed.png" />

For example, this right here would not be a linear transform, since the lines get all curvy.

<Figure image="$lesson/figures/what-makes-a-transformation-linear/NonLinearTransformationCurvedLines.png" />

And this one would not be a linear transformation because the origin moves.

<Figure image="$lesson/figures/what-makes-a-transformation-linear/NonLinearTransformationOriginMoves.png" />
...
<Figure image="$lesson/figures/what-makes-a-transformation-linear/NonLinearTransformationDiagonalLines.png" />
...
<Figure image="$lesson/figures/what-makes-a-transformation-linear/NonLinearTransformationDiagonalLinesGetCurved.png" />
...
<Figure image="$lesson/figures/what-makes-a-transformation-linear/GridLinesRemainParallelAndEvenlySpaced.png" />

<Figure image="$lesson/figures/what-makes-a-transformation-linear/ExampleRotateAboutOrigin.png" />
...
<Figure image="$lesson/figures/what-makes-a-transformation-linear/question1.png" />
