...
&
\begin{matrix}
\color{currentColor}6\color{green}x\color{currentColor}-3\color{red}y\color{currentColor}+2\color{blue}z\color{currentColor}=7 \\
\color{green}x\color{currentColor}+2\color{red}y\color{currentColor}+5\color{blue}z\color{currentColor}=0 \\
\underbrace{\color{currentColor}2\color{green}x\color{currentColor}-8\color{red}y\color{currentColor}-\color{blue}z\color{currentColor}=-2}
...
$$
\begin{align*}
\color{currentColor}2\color{green}x\color{currentColor}+5\color{red}y\color{currentColor}+3\color{blue}z\color{currentColor}&=-3 \\
\color{currentColor}4\color{green}x\color{currentColor}+0\color{red}y\color{currentColor}+8\color{blue}z\color{currentColor}&=0 \\
\color{currentColor}1\color{green}x\color{currentColor}+3\color{red}y\color{currentColor}+0\color{blue}z\color{currentColor}&=2
\end{align*}
$$
...
$$
\begin{align*}
\color{currentColor}2\color{green}x\color{currentColor}+2\color{red}y\color{currentColor}&=-4 \\
\color{currentColor}1\color{green}x\color{currentColor}+3\color{red}y\color{currentColor}&=-1
\end{align*}
\to
...
\overbrace{
\begin{matrix}
\color{currentColor}a\color{green}x\color{currentColor}+c\color{red}y\color{currentColor}=e \\
\color{currentColor}b\color{green}x\color{currentColor}+d\color{red}y\color{currentColor}=f
\end{matrix}
...
$$
\color{purple}\overrightarrow{\mathbf{x}}
\color{currentColor}=\color{orange}\overrightarrow{\mathbf{v}}
\\
\color{currentColor}
\begin{aligned}
\color{currentColor}2\color{green}x\color{currentColor}+5\color{red}y\color{currentColor}+3\color{blue}z\color{currentColor}&=-3 \\
