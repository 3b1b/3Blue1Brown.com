...
<Figure
  image="$lesson/riemann_anim.png"
  video="$lesson/riemann_anim.mp4"
  show="video"
/>
...
<PiCreature emotion="confused" flip />
...
<Figure image="$lesson/complex_exp.png" video="$lesson/complex_exp.mp4" loop />
...
<PiCreature emotion="confused">
  $\left( \frac{1}
  {2} \right)^{2 + i}$ is not repeated multiplication
</PiCreature>
...
<Figure image="$lesson/czeta_img1.png" video="$lesson/czeta_img1.mp4" />
...
<Figure image="$lesson/czeta_img2.png" />
...
<Figure
  image="$lesson/czeta_img3.png"
  video="$lesson/czeta_img3.mp4"
  show="video"
/>
...
<Figure image="$lesson/czeta_img4.png" />
...
<PiCreature emotion="happy" flip thought>
  How can we visualize this for all complex inputs?
</PiCreature>
...
<Figure image="$lesson/s2_img1.png" />
...
<Figure image="$lesson/s2_img2.png" />
...
<Figure image="$lesson/s2_img3.png" video="$lesson/s2_img3.mp4" show="video" />
...
<Figure image="$lesson/zeta_img1.png" />

<PiCreature emotion="happy">
  We've added more lines near 1, since it gets stretched out
</PiCreature>
...
<Figure
  image="$lesson/zeta_img2.png"
  video="$lesson/zeta_img2.mp4"
  show="video"
/>
...
<Figure image="$lesson/zeta_img7.png" />
...
<Figure image="$lesson/aconn_img1.png" />
...
<PiCreature emotion="confused">
  What's the derivative of a complex function?
</PiCreature>
...
<Figure image="$lesson/s2_img3.png" video="$lesson/s2_img3.mp4" />

For those of you who know calculus, you know you can take the derivative of $s^2$ at any input.

<PiCreature emotion="happy">$f'(s) = 2s$</PiCreature>
...
<Figure image="$lesson/aconn_img4.png" video="$lesson/aconn_img4.mp4" />
...
<Figure image="$lesson/aconn_img5.png" />
...
<Figure
  image="$lesson/aconn_img6.png"
  video="$lesson/aconn_img6.mp4"
  show="video"
/>
...
<Figure image="$lesson/czeta_img3.png" video="$lesson/czeta_img3.mp4" />
...
<Figure image="$lesson/rhyp_img1.png" />
...
<Figure image="$lesson/rhyp_img2.png">
  Here, we have -2, -4 and -6 on the number line prior to the transformation.
</Figure>

<Figure image="$lesson/rhyp_img3.png" video="$lesson/rhyp_img3.mp4">
  Notice how they all map onto 0
</Figure>
...
<Figure image="$lesson/rhyp_img4.png" />
...
<Collapsible title="A quick sneak peek of why the zeta function carries information about primes">

Let's define the prime counting function $\pi(x)$ as the number of primes less than or equal to $x$

<Figure image="$lesson/prime_img1.png" />
...
Where $\rho$ refers to the non-trivial zeros of the zeta function. Let's visualize this:

<Figure video="$lesson/prime.mp4" />
...
<Figure image="$lesson/rhyp_img5.png" />
...
<Figure image="$lesson/rhyp_img6.png">
  Here's the critical line, $\mathrm{Re} (s)=\frac{1}
  {2}$, before the transformation
</Figure>

<Figure image="$lesson/rhyp_img7.png" video="$lesson/rhyp_img7.mp4">
  Here's the critical line, $\mathrm{Re} (s)=\frac{1}
...
<Figure image="$lesson/rhyp_img8.png">
  A longer sample of the critical line after the transformation
</Figure>
...
[^4]:
    We can see this from the formula of the Riemann Zeta Function with analytic continuation:<br/><br/>
    $\zeta(s)=2^{s} \pi^{s-1} \sin \left(\frac{\pi s}{2}\right) \Gamma(1-s) \zeta(1-s)$.<br/><br/>
    The $\sin \left(\frac{\pi s}{2}\right)$ term equates 0 for negative even numbers, causing the zeta function to equal zero. For positive even numbers, the zeta function forms something called a pole, so those are ruled out. But that's for another lesson.
