...
<PiCreature emotion="confused" flip={true} className="self-center" />
...
<PiCreature emotion="confused" className="self-center">
  $\left( \frac{1}
...
<PiCreature emotion="happy" flip={true} thought={true} className="self-center">
...
<PiCreature emotion="happy" className="self-center">
...
<PiCreature emotion="hooray" className="self-center">
  Damn!
</PiCreature>
