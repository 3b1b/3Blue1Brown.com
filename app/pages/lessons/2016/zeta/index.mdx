...
<Figure image="$lesson/complex_exp.jpg" video="$lesson/complex_exp.mp4" loop />
...
<Figure image="$lesson/czeta_img1.jpg" video="$lesson/czeta_img1.mp4" />
...
<Figure image="$lesson/czeta_img2.jpg" />
...
<Figure image="$lesson/czeta_img4.jpg" />
...
<Figure image="$lesson/s2_img1.jpg" />
...
<Figure image="$lesson/s2_img2.jpg" />
...
<Figure image="$lesson/s2_img3.jpg" video="$lesson/s2_img3.mp4" show="video" />
...
<Figure image="$lesson/zeta_img1.jpg" />
...
<Figure image="$lesson/zeta_img7.jpg" />
...
<Figure image="$lesson/aconn_img1.jpg" />
...
<Figure image="$lesson/s2_img3.jpg" video="$lesson/s2_img3.mp4" />
...
<Figure image="$lesson/aconn_img4.jpg" video="$lesson/aconn_img4.mp4" />
...
<Figure image="$lesson/aconn_img5.jpg" />
...
<Figure image="$lesson/czeta_img3.jpg" video="$lesson/czeta_img3.mp4" />
...
<Figure image="$lesson/rhyp_img1.jpg" />
...
<Figure image="$lesson/rhyp_img2.jpg">
  Here, we have -2, -4 and -6 on the number line prior to the transformation.
</Figure>

<Figure image="$lesson/rhyp_img3.jpg" video="$lesson/rhyp_img3.mp4">
...
<Figure image="$lesson/rhyp_img4.jpg" />
...
<Figure image="$lesson/prime_img1.jpg" />
...
<Figure image="$lesson/rhyp_img5.jpg" />
...
<Figure image="$lesson/rhyp_img6.jpg">
  Here's the critical line, $\mathrm{Re} (s)=\frac{1}
  {2}$, before the transformation
</Figure>

<Figure image="$lesson/rhyp_img7.jpg" video="$lesson/rhyp_img7.mp4">
  Here's the critical line, $\mathrm{Re} (s)=\frac{1}
...
<Figure image="$lesson/rhyp_img8.jpg">
...
<Figure image="$lesson/zetaviz_img1.jpg" />
