...
Here I'd like to explain the most absurd occurance of pi I've ever seen.
...
<Figure
  image="$lesson/draw-energy-ellipse.png"
...
<Figure
  image="$lesson/energy-circle.png"
...
<Figure
  image="$lesson/conservation-of-momentum.png"
>
...
<Figure
  image="$lesson/one-possible-point.png"
>
...
<Figure
  image="$lesson/triangular-region.png"
>
...
<Figure image="$lesson/inscribed-angle-theorem.png" />
...
<Figure image="$lesson/2theta.png" />
...
<Figure image="$lesson/placed-arcs.png" video="$lesson/placing-arcs.mp4" />
...
\footnotesize \textcolor{blue}\text{Maximal integer?}
$$
...
<Figure image="$lesson/theta-table.png" />
...
<Figure image="$lesson/tan-arctan.png" />
...
<Figure image="$lesson/tan-triangle.png" />
...
<Figure image="$lesson/tan-taylor.png" />
...
<Figure image="$lesson/conservation-laws.png" />
...
<Figure image="$lesson/placed-arcs.png" />
...
<Figure image="$lesson/x-approximates-arctan.png" />
...
<Figure image="$lesson/phase-space.png" />
...
<Figure image="$lesson/mirrors-teaser.png" />
