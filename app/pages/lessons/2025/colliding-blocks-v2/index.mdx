...
<Figure video="$lesson/frictionless-elastic-collisions.mp4" />
...
<Figure video="$lesson/energy-remains-constant.mp4" />

The total momentum of the two blocks is $\textcolor{blue}{m_1}\textcolor{red}{v_1} + \textcolor{blue}{m_2}\textcolor{red}{v_2}$. This also remains constant when the blocks hit each other, but it _can_ change as the second block bounces off the wall. In reality, that second block would transfer its momentum to the wall during this collision. Again, we're being idealistic, thinking of the wall as having infinite mass, so such a momentum transfer won't actually move the wall.

<Figure video="$lesson/momentum-remains-constant.mp4" />
...
<Figure video="$lesson/velocities-in-phase-space.mp4" />
...
<Figure
  image="$lesson/draw-energy-ellipse.jpg"
  video="$lesson/draw-energy-ellipse.mp4"
>
...
<Figure
  image="$lesson/energy-circle.jpg"
  video="$lesson/energy-circle.mp4"
>
...
<Figure
  image="$lesson/conservation-of-momentum.jpg"
>
...
<Figure
  image="$lesson/one-possible-point.jpg"
>
...
<Figure video="$lesson/1st-collision.mp4" />
...
<Figure video="$lesson/2nd-collision.mp4" />
...
<Figure
  image="$lesson/triangular-region.jpg"
>
...
<Figure video="$lesson/complete-process.mp4" />
...
<Figure image="$lesson/inscribed-angle-theorem.jpg" />
...
<Figure image="$lesson/2theta.jpg" />
...
<Figure image="$lesson/placed-arcs.jpg" video="$lesson/placing-arcs.mp4" />
...
$$
\textcolor{blue}{\underbrace{\textcolor{currentColor}{2 \theta+2 \theta+2 \theta+\cdots+2 \theta}}_{\text {Max number of times? }}}<2 \pi
$$
...
\fcolorbox{currentColor}{#0000}{$\textcolor{blue}{314}\cdot(0.01) = 3.14 \textcolor{green}{< \pi}$} \\[1.5pt]
...
<Figure image="$lesson/theta-table.jpg" />

For example, $\arctan(1/100)$, corresponding to a big mass of 10,000 kilograms, is extremely close to 1/100.

In fact, it's so close that for the sake of our central question, it might as well _be_ 1/100. That is, analogous to what we saw a moment ago, adding this to itself 314 times won't surpass $\pi$, but the 315th time would.
...
\fcolorbox{currentColor}{#0000}{$\textcolor{blue}{314}\cdot(0.0099996667) = 3.1398953438 \textcolor{green}{< \pi}$} \\[1.5pt]
...
\fcolorbox{currentColor}{#0000}{$\textcolor{blue}{3141}\cdot(0.0009999997) = 3.1409990577 \textcolor{green}{< \pi}$} \\[1.5pt]
...
<Figure image="$lesson/tan-arctan.jpg" />
...
<Figure image="$lesson/tan-triangle.jpg" />
...
<Figure image="$lesson/tan-taylor.jpg" />
...
<Figure image="$lesson/conservation-laws.jpg" />
...
<Figure image="$lesson/placed-arcs.jpg" />
...
<Figure image="$lesson/x-approximates-arctan.jpg" />

I'll emphasize again what this phase space allowed us to do, because this is a lesson useful for all sorts of math, like differential equations, chaos theory, and other flavors of dynamics: By representing the relevant _state_ of your system as a single _point_ in an abstract space, it lets you translate problems of dynamics into problems of geometry.

<Figure image="$lesson/phase-space.jpg" />
...
<Figure image="$lesson/mirrors-teaser.jpg" />
...
[^1]:
    This difference between $\arctan(x)$ and $x$ could be problematic for our final count if, at some point when you're looking at the first $2n$ digits of $\pi$, the last $n$ of them are all 9's. It seems exceedingly unlikely that this should be true.
