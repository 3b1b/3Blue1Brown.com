...
<Figure image="$lesson/mirrors-photo.jpg" />
...
<Figure image="$lesson/d1-and-d2.jpg" />
...
<Figure image="$lesson/x-equals-y.jpg" video="$lesson/x-equals-y.mp4" />
...
<Figure image="$lesson/incidence-not-equal-reflection.jpg" />
...
<Figure image="$lesson/90-degree-reflection.jpg" />
...
<Figure
  image="$lesson/rescale-coordinates.jpg"
...
<Figure image="$lesson/kinematics-optics.jpg" />
...
<Figure image="$lesson/vector-velocity.jpg" />
...
<Figure image="$lesson/velocity-components.jpg" />
...
<Figure image="$lesson/velocity-magnitude.jpg" />
...
<Figure image="$lesson/new-slope.jpg" />
...
<Figure image="$lesson/what-next.jpg" />
...
<Figure image="$lesson/velocity-vector.jpg" />
...
<Figure image="$lesson/both-vectors.jpg" />
...
<Figure image="$lesson/dot-product.jpg" />
...
<Figure image="$lesson/incidence-equals-reflection.jpg" />
...
<Figure image="$lesson/bottom-like-mirror.jpg" />
...
<Figure
  image="$lesson/flip-world-once.jpg"
...
<Figure image="$lesson/real-mirror.jpg" />
...
<Figure image="$lesson/real-mirror-mismatch.jpg">
