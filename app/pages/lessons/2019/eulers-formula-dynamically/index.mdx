...
<Figure image="$lesson/1_equation.svg" />
...
<Figure image="$lesson/1_img.jpg" video="$lesson/1_img.mp4" show="video" />
...
<Figure image="$lesson/ExpGraph.jpg" />
...
<Figure image="$lesson/2_equation.svg" />
...
<Figure image="$lesson/2_img.jpg" video="$lesson/2_img.mp4" show="video" />
...
<Figure image="$lesson/3_equation.svg" />
...
<Figure
  image="$lesson/-0.5_img.jpg"
  video="$lesson/-0.5_img.mp4"
  show="video"
/>
...
<Figure image="$lesson/complex_equation.jpg" />
...
<Figure image="$lesson/RotatedVectors.jpg">
  Each blue arrow above pointing outward from the origin represents an example
  value of $e^{it}$, thought of as a position vector. The corresponding green
  arrow at its tip shows what the velocity, equal to the position rotated 90
  degrees counterclockwise, would have to be for that particular position.
</Figure>
...
<Figure image="$lesson/ExpVectorField.jpg" video="$lesson/vect_anim.mp4" />
...
<Figure
  video="$lesson/rotate_anim.mp4"
  image="$lesson/complex_img2.jpg"
  show="video"
/>

So after $\pi$ seconds, you've traced a distance of $\pi$ around; $e^{i\pi} = -1$.

<Figure image="$lesson/e^ipi.jpg" />

After $\tau = 2\pi$ seconds, you've gone full circle; $e^{i\tau} = 1$.

<Figure image="$lesson/e^itau.jpg" />

And more generally, $e^{it}$ equals a number $t$ radians [^1] around this circle.
