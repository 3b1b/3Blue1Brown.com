...
<Figure image="$lesson/1_img.png" video="$lesson/1_img.mp4" show="video" />
...
<Figure image="$lesson/ExpGraph.png" />
...
<Figure image="$lesson/2_img.png" video="$lesson/2_img.mp4" show="video" />
...
<Figure image="$lesson/complex_equation.png" />
...
<Figure image="$lesson/RotatedVectors.png">
...
<Figure image="$lesson/ExpVectorField.png" video="$lesson/vect_anim.mp4" />
