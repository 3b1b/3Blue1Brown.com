...
<Figure image="$lesson/you-soon.png">This is you, soon...</Figure>
...
<Figure image="$lesson/20-to-1.png">
...
<Figure image="$lesson/representative-sample.png" />
...
<Figure image="$lesson/who-fits.png">
...
<Figure image="$lesson/probability-given-description.png" />
...
<Figure image="$lesson/update-prior-beliefs.png">
...
<Figure image="$lesson/key-bayes-concepts.png" />
...
<Figure image="$lesson/write-mathematically.png">
...
<Figure image="$lesson/when-to-use.png" />
...
<Figure image="$lesson/given-notation.png" />
...
<Figure image="$lesson/likelihood.png" />
...
<Figure image="$lesson/p-e-given-not-h.png">
...
<Figure image="$lesson/final-answer-graphic.png" />
...
<Figure image="$lesson/where-did-4-come-from.png" />
...
<Figure image="$lesson/where-did-20-come-from.png" />

Once we have these numbers, we can assemble them into the Bayes' theorem fraction:

<Figure image="$lesson/total-cancels.png" />
...
<Figure image="$lesson/bayes-theorem.png" />
...
<Figure image="$lesson/posterior.png" />
...
<Figure image="$lesson/remember-this.png" />
...
<Figure image="$lesson/hypothesis-left.png" />
...
<Figure image="$lesson/restricted-space.png" />
...
<Figure image="$lesson/equal-likelihoods.png" />

But when these likelihoods are very different, your belief changes a lot.

<Figure image="$lesson/different-likelihoods.png" />
...
<Figure image="$lesson/bank-tellers.png">
...
<Figure image="$lesson/estimation.png" />
...
<Figure image="$lesson/phrases.png" />
...
<Figure image="$lesson/sample-vs-area.png">
...
<Figure image="$lesson/proportions-vs-uncertainty.png" />
...
<Figure image="$lesson/bayes-geometric.png" />
...
<Figure image="$lesson/scientists.png" />
...
<Figure image="$lesson/possible-shifts.png">
