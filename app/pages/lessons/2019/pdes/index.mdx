...
<Figure image="$lesson/setup_1.jpg" />
...
<Figure image="$lesson/setup_3.jpg" />
...
<Figure image="$lesson/setup_4.jpg" video="$lesson/setup_4.mp4" />
...
<Figure image="$lesson/context_1.jpg" />
...
<Figure image="$lesson/represent_1.jpg" />
...
<Figure image="$lesson/partial_1.jpg" />
...
<Figure image="$lesson/partial_3.jpg" />
...
<Figure image="$lesson/partial_4.jpg" />
...
<Figure image="$lesson/partial_5.jpg" />
...
<Figure image="$lesson/discrete_1.jpg" />
...
<Figure image="$lesson/discrete_2.jpg" />

</Question>

If the two neighbours are cooler on average, it will cool down.

<Figure image="$lesson/discrete_3.jpg" />
...
<Figure image="$lesson/discrete_7.jpg" />
...
<Figure image="$lesson/discrete_8.jpg" />
...
<Figure image="$lesson/discrete_9.jpg" />
...
<Figure image="$lesson/cont_1.jpg" />
...
<Figure image="$lesson/cont_2.jpg" />
...
<Figure image="$lesson/cont_3.jpg" />
...
<Figure image="$lesson/compare_1.jpg" />
...
<Figure image="$lesson/compare_2.jpg" />
...
<Figure image="$lesson/compare_3.jpg" />
