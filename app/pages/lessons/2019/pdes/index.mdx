...
<Figure image="$lesson/setup_1.png" />
...
<Figure video="$lesson/setup_2.mp4" />
...
<Figure image="$lesson/setup_3.png" />
...
<Figure image="$lesson/setup_4.png" video="$lesson/setup_4.mp4" />
...
<PiCreature emotion="confused">
  What does $\frac{\partial T}{\partial x}$ mean?
</PiCreature>
...
<Figure image="$lesson/context_1.png" />
...
<Figure image="$lesson/represent_1.png" />
...
<Figure image="$lesson/partial_1.png" />
...
<PiCreature emotion="happy" flip>
  $\Large\frac{dT}
  {dt}$
</PiCreature>

<Figure image="$lesson/partial_3.png" />
...
<Figure image="$lesson/partial_4.png" />
...
<Figure image="$lesson/partial_5.png" />
...
<Figure image="$lesson/discrete_1.png" />
...
<Figure image="$lesson/discrete_2.png" />

</Question>

If the two neighbours are cooler on average, it will cool down.

<Figure image="$lesson/discrete_3.png" />
...
<Figure image="$lesson/discrete_7.png" />
...
<Figure image="$lesson/discrete_8.png" />
...
<Figure image="$lesson/discrete_9.png" />
...
<Figure image="$lesson/cont_1.png" />
...
<Figure image="$lesson/cont_2.png" />
...
<Figure image="$lesson/cont_3.png" />
...
<Figure image="$lesson/compare_1.png" />
...
<Figure image="$lesson/compare_2.png" />
...
<Figure image="$lesson/compare_3.png" />
...
<Collapsible title="Strogatz mention!">
