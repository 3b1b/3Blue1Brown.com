---
title: Darts in Higher Dimensions [Numberphile]
...
<Figure image="$lesson/bullseye.png" video="$lesson/bullseye.mp4" />
...
<Figure image="$lesson/chord.png" video="$lesson/chord.mp4" show="video" />
...
<Figure image="$lesson/new_diameter.png" video="$lesson/new_diameter.mp4" />
...
<Interactive Component={lazy(() => import("./Game.jsx"))} />
...
<Figure image="$lesson/distributions.png" video="$lesson/distributions.mp4" />
...
<Figure image="$lesson/xy_coord.png" video="$lesson/xy_coord.mp4" />
...
<Figure image="$lesson/histogram.png" video="$lesson/histogram.mp4" />
...
<Figure image="$lesson/at_least_one.png" video="$lesson/at_least_one.mp4" />
...
<Figure image="$lesson/dart_triangle.svg" />
...
<Figure image="$lesson/prob_four.png" video="$lesson/prob_four.mp4" />
...
<Figure image="$lesson/4D_point.png" video="$lesson/4D_point.mp4" />
...
<Figure image="$lesson/histogram_volume.png" />
...
<Figure image="$lesson/greater_equal_collapse.png" />
...
<Collapsible title="Additional Game">
...
<Figure
  image="$lesson/triangle_area.png"
>
...
<Interactive Component={lazy(() => import("./Pyramid.jsx"))} />
