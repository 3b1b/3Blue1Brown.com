...
<Figure image="$lesson/bullseye.jpg" video="$lesson/bullseye.mp4" />
...
<Figure image="$lesson/chord.jpg" video="$lesson/chord.mp4" show="video" />
...
<Figure image="$lesson/new_diameter.jpg" video="$lesson/new_diameter.mp4" />
...
<Figure image="$lesson/distributions.jpg" video="$lesson/distributions.mp4" />
...
<Figure image="$lesson/xy_coord.jpg" video="$lesson/xy_coord.mp4" />
...
<Figure image="$lesson/histogram.jpg" video="$lesson/histogram.mp4" />
...
<Figure image="$lesson/at_least_one.jpg" video="$lesson/at_least_one.mp4" />
...
<Figure image="$lesson/prob_four.jpg" video="$lesson/prob_four.mp4" />
...
<Figure image="$lesson/4D_point.jpg" video="$lesson/4D_point.mp4" />
...
<Figure image="$lesson/histogram_volume.jpg" />
...
<Figure image="$lesson/greater_equal_collapse.jpg" />
...
<Figure
  image="$lesson/triangle_area.jpg"
>
