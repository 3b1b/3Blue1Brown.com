...
<Figure image="$lesson/usa_imo.jpg" />
...
<Figure image="$lesson/intro_img1.jpg" />
...
<Figure image="$lesson/intro_img2.jpg" />
...
<Figure
  image="$lesson/intro_img3.jpg"
  video="$lesson/intro_img3.mp4"
  show="video"
/>
...
<Figure
  image="$lesson/intro_img4.jpg"
  video="$lesson/intro_img4.mp4"
  show="video"
/>
...
<Spoiler>
  Otherwise, the windmill process would be ambiguous. If the line hits three
  points at once, it's not well defined which point becomes the new pivot.
</Spoiler>
...
<Figure
  image="$lesson/intro_img5.jpg"
  video="$lesson/intro_img5.mp4"
  show="video"
/>
...
<Figure image="$lesson/unusual_img1.jpg" />
...
<Figure image="$lesson/unusual_img2.jpg" />
...
<Figure image="$lesson/2_img.jpg" video="$lesson/2_img.mp4" show="video" loop />
...
<Figure image="$lesson/3_img.jpg" video="$lesson/3_img.mp4" show="video" loop />
...
<Figure
  image="$lesson/4_outer.jpg"
  video="$lesson/4_outer.mp4"
  show="video"
  loop
/>
...
<Figure
  image="$lesson/4_never.jpg"
  video="$lesson/4_never.mp4"
  show="video"
  loop
/>
...
<Figure image="$lesson/4_question.jpg" />
...
<Figure image="$lesson/4_img.jpg" video="$lesson/4_img.mp4" show="video" />
...
<Figure image="$lesson/middle.jpg" video="$lesson/middle.mp4" />
...
<Figure image="$lesson/introduce_colors.jpg" />
...
<Figure
  image="$lesson/constant.jpg"
  video="$lesson/constant.mp4"
  show="video"
/>
...
<Figure image="$lesson/change_pivot.jpg" video="$lesson/change_pivot.mp4" />
...
<Figure image="$lesson/odd_img2.jpg" video="$lesson/odd_img.mp4" show="video" />
...
<Figure image="$lesson/even_intro.jpg" />
...
<Figure
  image="$lesson/even_img.jpg"
  video="$lesson/even_img.mp4"
  show="video"
/>
...
<Figure image="$lesson/different.jpg" />
...
<Figure image="$lesson/topology.jpg" />
