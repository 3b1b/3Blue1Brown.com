...
<Figure image="$lesson/usa_imo.png" />
...
<Figure image="$lesson/intro_img1.png" />
...
<Figure image="$lesson/intro_img2.png" />
...
<Figure image="$lesson/unusual_img1.png" />
...
<Figure image="$lesson/unusual_img2.png" />
...
<Figure image="$lesson/2_img.png" video="$lesson/2_img.mp4" show="video" loop />
...
<Figure image="$lesson/3_img.png" video="$lesson/3_img.mp4" show="video" loop />
...
<Figure image="$lesson/4_question.png" />
...
<Figure image="$lesson/4_img.png" video="$lesson/4_img.mp4" show="video" />
...
<Figure image="$lesson/middle.png" video="$lesson/middle.mp4" />
...
<Figure image="$lesson/introduce_colors.png" />
...
<Figure image="$lesson/change_pivot.png" video="$lesson/change_pivot.mp4" />
...
<Figure image="$lesson/odd_img2.png" video="$lesson/odd_img.mp4" show="video" />
...
<Figure image="$lesson/even_intro.png" />
...
<Figure image="$lesson/different.png" />
...
<Figure image="$lesson/topology.png" />
