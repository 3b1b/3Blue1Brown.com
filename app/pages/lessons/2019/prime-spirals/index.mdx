...
<Figure image="$lesson/ppp_writing.png" />
...
<Figure image="$lesson/polar_coords.png" video="$lesson/polar_coords.mp4" />
...
<Figure image="$lesson/plotting_primes.png" />
...
<Figure image="$lesson/integer_plot.png" />
...
<Figure image="$lesson/archimedean_spiral.png" />
...
<Figure
  image="$lesson/galactic_zoomout.png"
...
<Figure image="$lesson/galactic_comb.png" video="$lesson/galactic_comb.mp4" />
...
<Figure image="$lesson/ray_count.png" video="$lesson/ray_count.mp4" />
...
<Figure image="$lesson/integer_rays.png" video="$lesson/integer_rays.mp4" />
...
<Figure image="$lesson/6_spirals.png" video="$lesson/6_spirals.mp4" />
...
<Figure image="$lesson/6_steps.png" video="$lesson/6_steps.mp4" />
...
<Figure image="$lesson/6_prime_spiral.png" video="$lesson/6_prime_spiral.mp4" />
...
<Figure image="$lesson/44_spiral.png" />
...
<Figure image="$lesson/44_7_approx.png" />
...
<Figure image="$lesson/44_residue_arm.png" video="$lesson/44_residue_arm.mp4" />
...
<Figure image="$lesson/prime_spiral_numbered_circle.png">
...
<Figure image="$lesson/coprime_definition.png" />
...
<Figure image="$lesson/710_113_approx.png" />
...
<Figure image="$lesson/710_spiral.png" video="$lesson/710_spiral.mp4">
...
<Figure image="$lesson/710_galaxy.png" />
...
<Figure image="$lesson/710_factors.png" />
...
<Figure image="$lesson/filtering_quad.png" video="$lesson/filtering_quad.mp4">
...
<Figure image="$lesson/280_calculation.png" />
...
<Figure image="$lesson/710_rainbow.png">
...
<Figure image="$lesson/residue_class_mod_10.png" />
...
<Figure image="$lesson/primes_mod_10.png" />
...
<Figure image="$lesson/histogram_mod_10.png" video="$lesson/histogram_mod_10.mp4">
...
<Figure image="$lesson/histogram_mod_44.png" video="$lesson/histogram_mod_44.mp4">
...
$ \lim\_{x\to\infty}\left(\frac{\color{blue}\pi\color{black}(x;6,1)} {\color{blue}\pi\color{black}(x)}\right) = \frac1{\phi(6)} $ and we know from counting the visible arms on the smallest spiral that $\phi(6)=2$
...
<Figure image="$lesson/quad_histogram.png" video="$lesson/quad_histogram.mp4" />
...
<Figure image="$lesson/many_connections.png" />
...
<Figure image="$lesson/3b1b_spiral.png" />
