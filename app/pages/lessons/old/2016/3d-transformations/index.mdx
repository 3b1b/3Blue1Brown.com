...
<Figure
  image="$lesson/figures/three-dimensions/VectorAsTransformationBefore.svg"
  className="w-72"
/>
...
<Figure
  image="$lesson/figures/three-dimensions/VectorAsTransformationAfter.svg"
  className="w-72"
/>
