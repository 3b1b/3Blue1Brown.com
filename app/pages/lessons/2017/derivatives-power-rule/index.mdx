...
$$
(x + dx)^3 = x^3 + \color{#fc6255} 3x^2 \color{currentColor} dx \color{#AAAAAA} + 3xdx^2 + dx^3
$$
...
| ------------ | ------------------------------------------------------------------------------------------------------------------ |
| $f(x) = x^1$ | $(x + dx)^1 = x + \color{#fc6255}{1} \color{currentColor} dx$                                                             |
| $f(x) = x^2$ | $(x + dx)^2 = x^2 + \color{#fc6255} 2x \color{currentColor} dx \color{#AAAAAA} + dx^2$                                    |
| $f(x) = x^3$ | $(x + dx)^3 = x^3 + \color{#fc6255} 3x^2 \color{currentColor} dx \color{#AAAAAA} + 3xdx^2 + dx^3$                         |
| $f(x) = x^4$ | $(x + dx)^4 = x^4 + \color{#fc6255} 4x^3 \color{currentColor} dx \color{#AAAAAA} + 6x^2dx^2 + 4xdx^3 + dx^4$              |
| $f(x) = x^5$ | $(x + dx)^5 = x^5 + \color{#fc6255} 5x^4 \color{currentColor} dx \color{#AAAAAA} + 10x^3dx^2 + 10x^2dx^3 + 5xdx^4 + dx^5$ |

{/* | $f(x) = x^6$ | $(x + dx)^6 = x^6 + \color{#fc6255} 6x^5 \color{currentColor} dx \color{#AAAAAA} + 15x^4dx^2 + 20x^3dx^3 + 15x^2dx^4 + 6xdx^5 + dx^6$ | */}
