...
<Figure image="$lesson/guesses.jpg" />
...
<Figure image="$lesson/breakdown.jpg" />
...
<Figure image="$lesson/progress1.jpg" />
...
<Figure image="$lesson/progress2.jpg" />
...
<Figure image="$lesson/kilogoogle.jpg" />
...
<Figure image="$lesson/progress3.jpg" />
...
<Figure image="$lesson/planet.jpg" />
...
<Figure image="$lesson/progress4.jpg" />
...
<Figure image="$lesson/milkyway.jpg" />

### 4 Billion Milky Ways

<Figure image="$lesson/progress5.jpg" />
...
<Figure image="$lesson/ggsc.jpg" />

### 4 Billion Seconds

<Figure image="$lesson/progress6.jpg" />
...
<Figure image="$lesson/progress7.jpg" />
...
<Figure image="$lesson/progress8.jpg" />
