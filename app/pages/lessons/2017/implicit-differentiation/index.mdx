...
<Figure image="$lesson/figures/ladder-setup.png" />
...
<Figure
  image="$lesson/figures/ladder-rate-of-change.png"
...
<Figure image="$lesson/figures/ladder-time-variable.png" />
...
<Figure image="$lesson/figures/ladder-traditional-derivative.png" />
...
<Figure image="$lesson/figures/ladder-function-of-time.png" />
...
<Figure image="$lesson/figures/function-of-two-variables-dx-dy-algebra.svg">
  ...
  second power are neglible as the nudges approaches zero.
</Figure>
...
<Figure image="$lesson/figures/natural-logarithm-and-exponential-functions-diagonal-line.svg">
  ...
  reflect the functions to see that they are inverses of eachother.
</Figure>
