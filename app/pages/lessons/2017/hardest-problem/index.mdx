...
description: A challenging question of geometry and probability on the Putnam.  The shift in perspective used for the solution here carries with it broader lessons for problem-solving.
date: 2017-12-08
video: OkmNXy7er84
...
<Figure image="$lesson/putnam_overview.jpg" />
...
<Figure image="$lesson/2sphere.jpg" />
...
<Figure image="$lesson/green_shell.jpg" />
...
<Figure image="$lesson/new_objects.jpg" />
...
<Figure image="$lesson/procedure.jpg" />
...
<Figure image="$lesson/procedure_2.jpg" />
...
<Figure image="$lesson/differentiate.jpg" />
...
<Figure image="$lesson/sphere_procedure.jpg" />
