...
<Figure image="$lesson/figure-1.05.jpg">(A few) Inventors of Calculus</Figure>
...
<Figure image="$lesson/figure-2.43.svg">Distance and Velocity Graphs</Figure>
...
<Figure image="$lesson/figure-2.57.svg">
  In this graph, the car starts from a stopped position, speeds up and slows
  down back to a stopped position at $5$ seconds time. Then the car speeds up
  and slows down again to a stopped position at $10$ seconds time.
</Figure>
...
<Collapsible title="Show velocity graph">
...
<Figure image="$lesson/figure-10.50.svg">
  This figure graphs the position function $s(t) = t^3$ and also highlights the
  point at $t=2$.
</Figure>
