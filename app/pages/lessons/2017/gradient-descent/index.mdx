...
<Figure image="$lesson/three-3s.png">
...
<Figure image="$lesson/pixels-as-input.png">
...
<Figure
  image="$lesson/recap-propagation.png"
...
<Figure image="$lesson/layer-hypothesis.png">
...
<Figure image="$lesson/training-data.png">
...
<Figure image="$lesson/training-vs-testing.png">
...
<Figure image="$lesson/finding-minima.png">
...
<Figure image="$lesson/weights-and-biases.png">
...
<Figure image="$lesson/random-trash.png">
...
<Figure image="$lesson/cost-of-difference.png">
...
<Figure image="$lesson/cost-ranking-question.png" />
...
<Figure image="$lesson/neural-network-function.png">
...
<Figure image="$lesson/cost-function.png">
...
<Figure image="$lesson/single-input-cost.png">
...
<Figure image="$lesson/infeasible-minimum.png">
...
<Figure image="$lesson/follow-slope.png" video="$lesson/follow-slope.mp4">
...
<Figure image="$lesson/2-input-cost.png">
...
<Figure image="$lesson/negative-gradient.png">
...
<Figure
  image="$lesson/weights-and-gradient.png"
...
<Figure image="$lesson/gradient-explained.png" />
...
<Figure image="$lesson/weight-importance.png">
...
<Figure image="$lesson/nudges-on-network.png">
