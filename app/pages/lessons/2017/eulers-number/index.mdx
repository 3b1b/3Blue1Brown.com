...
<Quote name="Francois le Lionnais">
...
$$
\frac{2^{0.001}-1}{0.001} = \color{green} 0.693 \color{gray} 387462581
$$

Substituting $0.0001$ in for $dt$ we get the value.

$$
\frac{2^{0.0001}-1}{0.0001} = \color{green}  0.6931  \color{gray} 71203765
$$

And, Substituting $0.00001$ in for $dt$ we get the value.

$$
\frac{2^{0.00001}-1}{0.00001} = \color{green} 0.69314 \color{gray} 958282
$$
