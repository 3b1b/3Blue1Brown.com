...
<Figure image="$lesson/neural-network.jpg">
...
<Figure image="$lesson/relative-weight-importance.jpg">
...
<Figure image="$lesson/notation.jpg">
...
<Figure image="$lesson/cost-of-one-example.jpg">
...
<Figure image="$lesson/output-trash.jpg">
...
<Figure image="$lesson/classify-as-2.jpg" />
...
<Figure image="$lesson/focus-on-2-neuron.jpg" />
...
<Figure image="$lesson/output-neuron-equation.jpg" />
...
<Figure image="$lesson/weights-proportional-to-activations.jpg">
...
<Figure image="$lesson/hebbian-theory.jpg">
...
<Figure image="$lesson/activations-proportional-to-weights.jpg">
...
<Figure image="$lesson/no-direct-influence.jpg">
...
<Figure image="$lesson/other-output-desires.jpg">
...
<Figure image="$lesson/propagate-backwards.jpg">
...
<Figure image="$lesson/desires-of-2.jpg">
...
<Figure image="$lesson/average-over-all.jpg">
...
<Figure image="$lesson/proportional-to-gradient.jpg">
...
<Figure image="$lesson/mini-batches.jpg" />
...
<Figure image="$lesson/stochastic-comparison.jpg">
