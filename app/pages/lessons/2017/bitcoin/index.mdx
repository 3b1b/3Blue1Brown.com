...
<Figure image="$lesson/user-interface.png">
...
<Figure image="$lesson/ledger.png">
...
<Figure image="$lesson/without-signatures.png">
...
<Figure image="$lesson/signatures.png">
...
<Figure image="$lesson/couldnt-you-copy.png" />
...
<Figure image="$lesson/different-signatures.png">
...
<Figure image="$lesson/pk-and-sk.png">
...
<Figure image="$lesson/many-possible-signatures.png" />
...
<Figure image="$lesson/ledger-with-signatures.png" />
...
<Figure image="$lesson/duplicate-transaction.png">
...
<Figure image="$lesson/unique-ids.png">
...
<Figure
  image="$lesson/charlie-leaves.png"
...
<Figure image="$lesson/pay-in-100.png">
...
<Figure image="$lesson/invalid.png">
...
<Figure image="$lesson/overdrawn.png">
...
<Figure image="$lesson/ledgerdollars.png" />
...
<Figure
  image="$lesson/exchange-for-usd.png"
...
<Figure image="$lesson/exchange-currency.png" />
...
<Figure image="$lesson/ledger-is-currency.png" />
...
<Figure image="$lesson/who-controls-this.png">
...
<Figure image="$lesson/are-these-the-same.png">
...
<Figure image="$lesson/transactions-from-the-void.png" />
...
<Figure image="$lesson/hash-function.png" />
...
<Interactive Component={lazy(() => import("./Sha"))} />
...
<Figure image="$lesson/inverse-is-infeasible.png">
...
<Figure image="$lesson/reverse-engineer.png">
...
<Interactive Component={lazy(() => import("./Zeroes"))} />
...
<Figure image="$lesson/30-zeroes.png" />
...
<Figure image="$lesson/ledgers.png">
...
<Figure image="$lesson/blocks.png" />
...
<Figure image="$lesson/60-zeroes.png" />
...
<Figure image="$lesson/block-ordering.png" />
...
<Figure image="$lesson/block-reward.png" />
...
<Figure image="$lesson/only-track-blocks.png">
...
<Figure image="$lesson/conflicting-chains.png" />
...
<Figure image="$lesson/alice-never-paid-bob.png" />
...
<Figure image="$lesson/trust-longest-chain.png" />
...
<Figure image="$lesson/dont-trust-yet.png">
...
<Figure image="$lesson/transaction-fee.png" />
...
<Figure image="$lesson/limited-to-2400.png" />
...
<Figure image="$lesson/personal-ledger.png" />
...
<Figure image="$lesson/lock-in.png" />
...
<Figure image="$lesson/lock-in-unused.png" />
...
<Figure image="$lesson/lightning-forwarding.png" />
