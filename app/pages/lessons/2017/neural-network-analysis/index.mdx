...
<Interactive
  Component={lazy(() => import("../neural-networks/NeuralNetwork.jsx"))}
  instant
/>
...
<Figure image="$lesson/wrong-answers.jpg">
...
<Figure image="$lesson/second-layer-weights.jpg">
...
<Figure image="$lesson/random-input.jpg">
...
<Figure image="$lesson/confused-network.jpg">
