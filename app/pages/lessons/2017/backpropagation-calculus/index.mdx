...
<Figure image="$lesson/activation-labels.png">
...
<Figure image="$lesson/tree-extended.png" />
...
<Figure image="$lesson/tree-with-number-lines.png">
...
<Figure image="$lesson/tree-activation-highlighted.png">
...
<Figure image="$lesson/complicated-activation-labels.png">
...
<Figure image="$lesson/index-by-j-k.png" />
...
<Figure image="$lesson/complicated-cost.png" />
...
<Figure image="$lesson/complicated-weight-label.png" />
...
<Figure image="$lesson/summary.png">
