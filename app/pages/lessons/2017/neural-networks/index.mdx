...
<Figure image="$lesson/plain-vanilla.jpg">
...
<Figure image="$lesson/pixel-values.jpg">
...
<Figure
  image="$lesson/highlight-first-layer.jpg"
...
<Figure image="$lesson/output-layer.jpg">
...
<Figure image="$lesson/confused-output-question.jpg" />
...
<Figure image="$lesson/hidden-layers.jpg" />
...
<Figure image="$lesson/loops-and-lines.jpg">
...
<Figure image="$lesson/upper-loop-neuron.jpg" />
...
<Figure image="$lesson/loop-edges.jpg">
...
<Figure image="$lesson/line-edges.jpg">
...
<Figure image="$lesson/edge-detection.jpg">
...
<Figure image="$lesson/desired-edge.jpg">
...
<Figure image="$lesson/weights-blue.jpg" />
...
<Figure image="$lesson/weights-square-blue.jpg">
...
<Figure image="$lesson/weights-attempt-1.jpg">
...
<Figure image="$lesson/weights-attempt-2.jpg">
...
<Figure image="$lesson/weights-question.jpg" />
...
<Figure
  image="$lesson/number-line-squish.jpg"
...
<Figure image="$lesson/sigmoid.jpg">
...
<Figure image="$lesson/13002-blue.jpg">
...
<Figure image="$lesson/annotated-equation.jpg" />
...
<Figure image="$lesson/sigmoid-old-school.jpg" />
