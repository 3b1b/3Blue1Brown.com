...
<Figure image="$lesson/matrix-math-videos/bias-vector.png" />
...
<Figure image="$lesson/matrix-math-videos/sigmoid.png" />
...
<Figure image="$lesson/matrix-math-videos/final-equation.png">
