...
<Figure image="$lesson/sphere-vs-circles.jpg" />
...
<Figure image="$lesson/paper-circle.jpg">Good luck.</Figure>
...
<Figure image="$lesson/two-proofs.jpg" />
...
<Figure image="$lesson/rectangle-dimensions.jpg" />
...
<Figure
  image="$lesson/projection-equal.jpg"
>
...
<Figure
  image="$lesson/width-scaled-up.jpg"
>
...
<Figure image="$lesson/slant-shadow.jpg" video="$lesson/slant-shadow.mp4" />
...
<Figure
  image="$lesson/height-variation.jpg"
>
...
<Figure image="$lesson/similar-triangles.jpg" />
...
<Figure
  image="$lesson/2d-cross-section.jpg"
...
<Figure
  image="$lesson/right-triangle.jpg"
>
...
<Figure image="$lesson/right-triangle-2.jpg" />
...
<Figure image="$lesson/alpha-and-beta.jpg" />
...
<Figure image="$lesson/small-triangle-angles.jpg" />
...
<Figure image="$lesson/small-triangle-angles-complete.jpg" />
...
<Figure image="$lesson/R-over-d.jpg" />
...
<Figure image="$lesson/before-and-after.jpg" />
...
<Figure image="$lesson/equal-in-limit.jpg" />
...
<Figure image="$lesson/surface-area-definition.jpg" />
...
<Figure
  image="$lesson/preparing-for-calculus.jpg"
>
...
<Figure
  image="$lesson/ring-to-slice.jpg"
>
...
<Figure image="$lesson/triangles-fit-rectangle.jpg" />
...
<Figure image="$lesson/direct-proof.jpg" />
...
<Figure
  image="$lesson/every-2nd-ring.jpg"
>
...
<Figure
  image="$lesson/labelled-with-theta.jpg"
...
<Figure image="$lesson/R-d-theta.jpg" />
...
<Figure image="$lesson/question-1.jpg" />
...
<Figure image="$lesson/question-1-diagram.jpg" />
...
<Figure image="$lesson/question-1b.jpg" />
...
<Figure image="$lesson/question-2.jpg" />
...
<Figure image="$lesson/height-squish-review.jpg" />
...
<Figure image="$lesson/question-2-diagram.jpg" />
...
<Figure image="$lesson/question-4.jpg" />
...
<Figure image="$lesson/question-5.jpg" />
...
<Figure
  image="$lesson/shadows-form-circle.jpg"
...
<Figure
  image="$lesson/alternating-rings.jpg"
>
...
<Figure
  image="$lesson/average-shadow.jpg"
