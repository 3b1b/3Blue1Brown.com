...
<Figure image="$lesson/jupiter.jpg" />
...
<Figure image="$lesson/symmetric_face.jpg" />
...
<Figure image="$lesson/symmetric_snowflake.jpg" />
...
<Figure image="$lesson/zoo_groups.jpg" />
...
<Figure
  image="$lesson/rotational_cube.jpg"
...
<Figure
  image="$lesson/reflection_cube.jpg"
...
<Figure image="$lesson/loose_face.jpg" video="$lesson/loose_face.mp4">
...
<Figure image="$lesson/permutation.jpg" />
...
<Figure image="$lesson/symmetric_hexagon.jpg" />
...
<Figure image="$lesson/101!.jpg" video="$lesson/101!.mp4" show="video" />
...
\begin{aligned}
\color{blue}\text{Conservation law}\color{currentColor}&\Leftrightarrow \color{green}\text{Symmetry} \\
\color{blue}\text{Momentum}\color{currentColor}&\Leftrightarrow \color{green}\text{Translation in space} \\
\color{blue}\text{Energy}\color{currentColor}&\Leftrightarrow \color{green}\text{Translation in time}
\end{aligned}
$$
...
<Figure image="$lesson/threes.jpg" />
...
<Figure image="$lesson/abstracted_snowflake.jpg" />
...
<Figure image="$lesson/literal_triplet.jpg" />
...
<Figure image="$lesson/closure.jpg" />
...
<Figure
  image="$lesson/multiplication_table.jpg"
...
<Figure image="$lesson/symbolic_table.jpg">
...
<Figure image="$lesson/dot_table_conversion.jpg" />
...
<Figure image="$lesson/identity_element.jpg" />
...
<Figure image="$lesson/snowflake_hexagon_iso.jpg" />
...
<Figure image="$lesson/cube_4perm_iso.jpg" />
...
<Figure
  image="$lesson/rotation_multiplication.jpg"
...
<Figure image="$lesson/abstract_3.jpg" />
...
<Figure image="$lesson/abstract_S4.jpg" />
...
<Figure image="$lesson/group_decomp.jpg" />
...
<Figure image="$lesson/no_quintic_formula.jpg" />
...
<Figure image="$lesson/fact_polynomials.jpg" />
...
<Figure image="$lesson/categorize_finite_groups.jpg" />
...
<Figure image="$lesson/classification_simple.jpg" />
...
<Figure image="$lesson/happy_family.jpg" />
...
<Figure image="$lesson/monster_gigabytes.jpg" />
...
<Figure image="$lesson/series_expansion.jpg" />
...
<Figure image="$lesson/string_theory.jpg" />
