...
<Figure image="$lesson/MotivatingExample.png" />
...
<Figure image="$lesson/Overview.png" />
...
<Figure image="$lesson/tokens.png" />
...
<Figure image="$lesson/MLPRecap.png" />
...
<Figure
  image="$lesson/DirectionExample.png"
>
...
<Figure image="$lesson/strong.png" />
...
<Figure image="$lesson/BothNames.png" />
...
<Figure image="$lesson/MLPJordan.png" />
...
<Figure image="$lesson/Step11.png" />
...
<Figure image="$lesson/Step12.png" />
...
<Figure image="$lesson/Step13.png" />
...
<Figure image="$lesson/Step14.png" />
...
<Figure image="$lesson/Step15Updated.png" />
...
<Figure image="$lesson/4embed.png" />
...
<Figure image="$lesson/Neurons1.png" />
...
<Figure image="$lesson/NeuralNetwork.png" />
...
<Figure image="$lesson/BNeuron.png" />
...
<Figure image="$lesson/MLPEnd.png" />
...
<Figure image="$lesson/Figure1.png" />
...
<Figure image="$lesson/Parameter.png" />
...
<Figure image="$lesson/TotalParam.png" />
...
<Figure image="$lesson/RandomDis.png" />
...
<Figure image="$lesson/RandomDis1.png" />
...
<Figure image="$lesson/GPTScale.png" />
...
<Figure image="$lesson/ManyMore.png" />
