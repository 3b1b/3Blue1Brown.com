...
<Figure image="$lesson/MotivatingExample.jpg" />
...
<Figure image="$lesson/Overview.jpg" />
...
<Figure image="$lesson/tokens.jpg" />
...
<Figure
  image="$lesson/manylayers.jpg"
>

There is also a certain normalization step in between, but we'll leave that for another lesson.
...
<Figure image="$lesson/MLPRecap.jpg" />
...
<Figure
  image="$lesson/DirectionExample.jpg"
>

In this case, this particular direction would encode _gender information_.
...
<Figure image="$lesson/strong.jpg" />
...
<Figure image="$lesson/BothNames.jpg" />
...
<Figure image="$lesson/MLPJordan.jpg" />
...
<Figure image="$lesson/Step11.jpg" />
...
<Figure image="$lesson/Step12.jpg" />
...
<Figure image="$lesson/Step13.jpg" />
...
<Figure image="$lesson/Step14.jpg" />
...
<Figure image="$lesson/Step15Updated.jpg" />
...
<Figure image="$lesson/4embed.jpg" />
...
<Figure image="$lesson/Neurons1.jpg" />
...
<Figure image="$lesson/NeuralNetwork.jpg" />
...
<Figure image="$lesson/BDirection.jpeg" />
...
<Figure image="$lesson/BNeuron.jpg" />
...
<Figure image="$lesson/MLPEnd.jpg" />
...
<Figure image="$lesson/Figure1.jpg" />
...
<Figure image="$lesson/Parameter.jpg" />
...
<Figure image="$lesson/TotalParam.jpg" />
...
<Figure image="$lesson/RandomDis.jpg" />
...
<Figure image="$lesson/RandomDis1.jpg" />
...
<Figure image="$lesson/GPTScale.jpg" />
...
<Figure image="$lesson/ManyMore.jpg" />
