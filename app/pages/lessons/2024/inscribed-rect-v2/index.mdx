...
<Figure image="$lesson/mobius-strip.png" />
...
<Figure image="$lesson/inscribed-square.png">
...
<Figure image="$lesson/circle-and-ellipse.png">
...
<Figure image="$lesson/inscribed-rectangle.png" />
...
<Figure image="$lesson/pairs-of-points.png">
...
<Figure image="$lesson/rectangle-properties.png">
...
<Figure image="$lesson/encode-in-3d.png">
...
<Figure image="$lesson/3d-point-example.png">
...
<Figure
  image="$lesson/drawing-3d-surface.png"
...
<Interactive Component={lazy(() => import("./Surface"))} />
...
<Figure
  image="$lesson/points-approach-x.png"
...
<Figure image="$lesson/ordered-pairs.png" />
...
<Figure image="$lesson/unordered-pairs.png" />
...
<Figure
  image="$lesson/deform-loop-to-line.png"
...
<Figure image="$lesson/point-pair-to-numbers.png">
...
<Figure image="$lesson/pair-to-square.png">
...
<Figure image="$lesson/square-alignment-arrows.png">
...
<Figure image="$lesson/roll-into-torus.png" video="$lesson/roll-into-torus.mp4">
...
<Figure image="$lesson/torus-and-loop-correspondence.png">
...
<Figure image="$lesson/matching-points.png">
...
<Figure image="$lesson/fold-square.png" video="$lesson/fold-square.mp4">
...
<Figure image="$lesson/pre-mobius-arrows.png">
...
<Figure image="$lesson/cut-triangle.png">
...
<Figure
  image="$lesson/rotate-and-snap.png"
...
<Figure image="$lesson/mobius-maps-to-surface.png">
...
<Figure
  image="$lesson/sudanese-band.png"
