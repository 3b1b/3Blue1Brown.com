...
<Figure image="$lesson/predict.png" />
...
<Figure image="$lesson/attent.png" />
...
<Figure image="$lesson/imagetraining.png" />
...
<Figure image="$lesson/linreg.png" />
...
<Figure image="$lesson/arrays.png" />
...
<Figure image="$lesson/distinction.png" />
...
<Figure image="$lesson/embedding.png" />
...
<Figure image="$lesson/gender.png" />
...
<Figure image="$lesson/HowToDot.png" />
...
<Figure image="$lesson/dotProduct.png" />
...
<Figure image="$lesson/InitialContext.png" />
...
<Figure image="$lesson/SoftMax.png" />
...
<Figure image="$lesson/howsoftmax.png" />
...
<Figure image="$lesson/temperatureReal.png" />
