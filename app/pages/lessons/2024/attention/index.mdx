...
<Figure image="$lesson/TokenConvenientLie.jpg" />
...
<Figure image="$lesson/SemanticMeaning.jpg" />
...
<Figure image="$lesson/lastChapter.jpg">

This is just one of the many examples of how directions in this high-dimensional space could correspond to aspects of a word's meaning.
...
<Figure image="$lesson/richerContext.jpg" />
...
<Figure image="$lesson/MoleExample.jpg" />
...
<Figure image="$lesson/passEmbedding.jpg" />
...
<Figure image="$lesson/TowerExample.jpg" />
...
<Figure image="$lesson/shortlong.jpg" />
...
<Figure image="$lesson/lastvector.jpg" />
...
<Figure image="$lesson/AllContext.jpg" />
...
<Figure image="$lesson/SimplerExample.jpg" />
...
<Figure image="$lesson/Embeddings.jpg" />
...
<Figure image="$lesson/queryvector.jpg">
...
<Figure image="$lesson/QuerySpace.jpg" />
...
<Figure image="$lesson/QueryKey.jpg">
...
<Figure image="$lesson/Normalized.jpg" />
...
<Figure image="$lesson/Compact.jpg" />

<Collapsible title="Warning on Notation">
...
<Figure image="$lesson/SoftMaxEq.jpg" />
...
<Figure image="$lesson/Prediction.jpg">
...
<Figure image="$lesson/Masking.jpg" />
...
<Figure image="$lesson/square.jpg">
...
<Figure image="$lesson/Update.jpg" />
...
<Figure image="$lesson/ValueVector.jpg">
...
<Figure image="$lesson/DeltaE.jpg" />
...
<Figure image="$lesson/SingleHead.jpg" />
...
<Figure image="$lesson/CountQueryKey.jpg" />
...
<Figure image="$lesson/ValueQueryKey.jpg" />
...
<Figure image="$lesson/LinearMap.jpg" />
...
<Figure image="$lesson/vdown.jpg">
  [Correction](https://github.com/3b1b/3Blue1Brown.com/issues/481): `d_output =
  128`
</Figure>
...
<Figure image="$lesson/AttentionHeadCount.jpg" />

<Collapsible title="Cross-attention head">
...
<Figure image="$lesson/CrossAttention.jpg" />
...
<Figure image="$lesson/CrossAttentionKeyQuery.jpg" />
...
<Figure image="$lesson/Example.jpg" />
...
<Figure image="$lesson/brakesUpdated.jpg" />
...
<Figure image="$lesson/MultiHeaded.jpg" />
...
<Figure image="$lesson/ManyMany.jpg" />
...
<Figure image="$lesson/AddEmbed.jpg" />
...
<Figure image="$lesson/ParameterCount2.jpg" />

<Collapsible title="What about the Output Matrix?">
...
<Figure image="$lesson/OutputMatrix.jpg" />
...
<Figure image="$lesson/Onscreen.jpg" />
...
<Figure image="$lesson/ManyBlocks.jpg">
...
<Figure image="$lesson/DeeperMeaning.jpg" />
...
<Figure image="$lesson/FinalCount.jpg">
