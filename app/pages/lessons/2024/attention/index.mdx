...
<Figure image="$lesson/TokenConventientLie.png" />
...
<Figure image="$lesson/SemanticMeaning.png" />
...
<Figure image="$lesson/lastChapter.png">
...
<Figure image="$lesson/RicherContext.png" />
...
<Figure image="$lesson/MoleExample.png" />
...
<Figure image="$lesson/passEmbedding.png" />
...
<Figure image="$lesson/TowerExample.png" />
...
<Figure image="$lesson/shortlong.png" />
...
<Figure image="$lesson/lastvector.png" />
...
<Figure image="$lesson/AllContext.png" />
...
<Figure image="$lesson/SimplerExample.png" />
...
<Figure image="$lesson/Embeddings.png" />
...
<Figure image="$lesson/queryvector.png">
...
<Figure image="$lesson/QuerySpace.png" />
...
<Figure image="$lesson/QueryKey.png">
...
<Figure image="$lesson/Normalized.png" />
...
<Figure image="$lesson/Compact.png" />
...
<Figure image="$lesson/SoftMaxEq.png" />
...
<Figure image="$lesson/Prediction.png">
...
<Figure image="$lesson/Masking.png" />
...
<Figure image="$lesson/square.png">
...
<Figure image="$lesson/Update.png" />
...
<Figure image="$lesson/ValueVector.png">
...
<Figure image="$lesson/DeltaE.png" />
...
<Figure image="$lesson/SingleHead.png" />
...
<Figure image="$lesson/CountQueryKey.png" />
...
<Figure image="$lesson/ValueQueryKey.png" />
...
<Figure image="$lesson/LinearMap.png" />
...
<Figure image="$lesson/AttentionHeadCount.png" />
...
<Figure image="$lesson/CrossAttention.png" />
...
<Figure image="$lesson/CrossAttentionKeyQuery.png" />
...
<Figure image="$lesson/Example.png" />
...
<Figure image="$lesson/brakesUpdated.png" />
...
<Figure image="$lesson/MultiHeaded.png" />
...
<Figure image="$lesson/ManyMany.png" />
...
<Figure image="$lesson/AddEmbed.png" />
...
<Figure image="$lesson/ParameterCount2.png" />
...
<Figure image="$lesson/OutputMatrix.png" />
...
<Figure image="$lesson/Onscreen.png" />
...
<Figure image="$lesson/ManyBlocks.png">
...
<Figure image="$lesson/DeeperMeaning.png" />
...
<Figure image="$lesson/FinalCount.png">
