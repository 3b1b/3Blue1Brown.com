...
<Figure image="$lesson/script.jpg" />
...
<Figure image="$lesson/probability.jpg" />
...
<Figure image="$lesson/append.jpg">
...
<Figure image="$lesson/billions.jpg" />
...
<Figure image="$lesson/training.jpg" />
...
<Figure image="$lesson/backpropogation.jpg" />
...
<Figure image="$lesson/pretraining.jpg" />
...
<Figure image="$lesson/google.jpg" />
...
<Figure image="$lesson/overover.jpg" />
