...
**Compressed weight-delta broadcasting** How to keep globally distributed inference clusters in sync with a training cluster without re-sending the full model each time.

This could be an animation, a diagram, or an interactive, together with a concise and clear written description.

When you apply, in the section asking you to share specific achievements and experiences, include a line saying "My answer to the 3b1b Talent challenge" with a link to your result.
