...
quote: Exceptional outcomes are accomplished by small teams of highly technical people
---
...
<div className="grid grid-cols-3 gap-8 *:size-full *:max-h-50 *:object-cover max-sm:grid-cols-1">
...
<Button to="https://jobs.ashbyhq.com/cognition" color="theme">
