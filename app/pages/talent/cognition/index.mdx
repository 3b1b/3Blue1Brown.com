...
<Button
  to="https://jobs.ashbyhq.com/cognition?utm_source=Kevg6jyyEB"
  color="critical"
...
The hardest problems in AI often live at the intersection of deep theory and real systems — ideas that are simple to use but genuinely hard to _understand_. TurboQuant is one of them.

TurboQuant is a recent vector-quantization algorithm that compresses the key–value cache behind large language models down to roughly 3 bits per value, with almost no loss in downstream quality and provably near-optimal distortion. It works by randomly rotating each vector to tame its geometry, quantizing coordinate-by-coordinate, and then spending a single extra bit to cancel the leftover bias. It's the kind of result that sounds like magic until you see exactly _why_ it works.

---

**The challenge.** Research how TurboQuant works, then create a visual — an animation, diagram, or interactive — that explains what you see as the _core insight_ that makes it effective. There's no single right answer. We want to see what you choose to emphasize, how you reason about a hard idea, and how clearly you can make it land.

A few starting points:

- [TurboQuant: Online Vector Quantization with Near-optimal Distortion Rate](https://arxiv.org/abs/2504.19874) — the original paper
- [TurboQuant: Redefining AI efficiency with extreme compression](https://research.google/blog/turboquant-redefining-ai-efficiency-with-extreme-compression/) — a more accessible overview

<FreeResponse placeholder="Link to your visual (a tweet, video, blog post, notebook, etc.)">
  {(input) => (
    <>
      <p>
        Ready to share it? When you submit an application, at the bottom of your
        resume, include this line:
      </p>
      <strong>My 3b1b × Cognition TurboQuant visual: {input}</strong>
      <Button
        to="https://jobs.ashbyhq.com/cognition?utm_source=Kevg6jyyEB"
        color="theme"
...
[SWE 1.6](https://cognition.ai/blog/swe-1-6) reflects how we think about building AI that actually works in practice - not just on benchmarks, but in the moment-to-moment experience of using it.
...
<Button
  to="https://cognition.ai/blog/swe-1-6"
  color="light"
  className="self-center"
>
  <BookIcon />
  Read More About SWE 1.6
</Button>
