...
import { GraduationCapIcon, RocketLaunchIcon } from "@phosphor-icons/react";
...
<div className="grid grid-cols-3 gap-8 *:size-full *:max-h-50 *:object-cover max-md:grid-cols-2 max-sm:grid-cols-1">
