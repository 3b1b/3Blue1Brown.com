...
extra:
  ...
  video: k86eUj4hgdc
  type: youtube
  caption: Positional Encodings and Group Theory
about: Everybody here is a math nerd. If you go up to someone and start explaining a math puzzle, they'll stop you before you can tell them how to solve it because they want to try it on their own.
---
...
<Tabs>
  <Panel title="Meet Our Team">
    <YouTube id={frontmatter.interview.video} thumbnail={thumbnail} />
  </Panel>
  <Panel title="Whiteboarding Session">
...
<div className="grid grid-cols-2 gap-8 *:self-stretch max-md:grid-cols-1">
  <Quote name="Declan, Machine Learning">
    One of the favorite parts of my job is that I can talk to anyone about what
    they're working on and pull in some of the smartest people I've ever met
    whenever I want. I think this is our greatest superpower.
  </Quote>
