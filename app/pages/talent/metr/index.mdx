...
interview:
  ...
  type: vimeo
  hash: c6f71a8907
about: It's kind of a blend between a PhD Lab and a start up, in the best possible way
---
...
<Tabs>
  <Panel title="Meet Our Team">
    <Vimeo id={frontmatter.interview.video} hash={frontmatter.interview.hash} />
  </Panel>
