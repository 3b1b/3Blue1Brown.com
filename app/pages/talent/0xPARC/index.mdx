...
<Vimeo video="1158109614" hash="c6f71a8907" className="aspect-video w-full" />

<Button to="https://0xparc.org/3b1b" color="accent" className="self-center">
...
<img src={robPresentation} alt="" className="w-80" />
...
<img src={airQualityMonitor} alt="" className="w-80" />
