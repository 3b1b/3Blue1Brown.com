...
<Vimeo id="1158109614" hash="c6f71a8907" />
...
If you're interested in learning why this problem has surprising connections to lattice-based cryptography and fully homomorphic encryption, check out [0xparc.org/3b1b#puzzle1](https://0xparc.org/3b1b#puzzle1)
...
<Collapsible title="Problem 1 (TST 2018/4)">
...
<Collapsible title="Problem 2 (homomorphic FFT).">
...
<Collapsible title="Problem 3 (A mod p system)">
...
<Collapsible title="Problem 4 (zero-knowledge factorization).">
...
[^1]:
    For those curious, p = 21888242871839275222246405745257275088548364400416034343698204186575808495617 is
