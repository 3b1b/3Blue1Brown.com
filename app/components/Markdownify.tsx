...
// remove spurious paragraphs generated by mdx
// https://github.com/mdx-js/mdx/issues/1798
// https://jasongerbes.com/blog/mdx-remove-unwanted-paragraph-tags
export const removeParagraph = (children: ReactNode) =>
  deepMap(children, (node, index) => {
    if (
      getElementName(node) === "p" &&
      isValidElement(node) &&
      typeof node.props === "object" &&
      node.props !== null
    )
      return <span key={index} className="trim" {...node.props} />;
    return node;
  });
