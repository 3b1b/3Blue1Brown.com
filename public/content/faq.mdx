...
For the following limited use cases, feel free to use the content without explicit permission, as long as there is clear attribution to either "3blue1brown" or "Grant Sanderson".

- Using still frames or clips for **offline**, e.g. for classroom or academic presentation.
- Embedding videos in your own site or blog, as long as its not behind a paywall.
- Referencing a 3blue1brown video in your own video, on YouTube or elsewhere, as long as you're using less than 10 seconds of footage. For anything longer, I'd feel more comfortable if you asked for explicit permission.

Otherwise, to re-upload the content in any way, for example if you represent an organization who wishes to use the content on an alternate platform, that will require purchasing a license. In that case, please fill out the [contact form](/faq#contact) below with details about what you are looking for.
