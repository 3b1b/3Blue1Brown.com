...
For these uses, feel free to use the content without explicity permission. In both cases, attribution to either "3blue1brown" or "Grant Sanderson" is appreciated.

- Use of some of the visuals offline for classroom usage or a presentation.
- Embedding videos in your own site or blog, as long as its not behind a paywall.
- If you're making your own video, on YouTube or elsewhere, and you want to reference a short clip from a 3blue1brown video less than 10 seconds

To re-upload the content in any way, for example if you represent an organization who wishes to use the content on an alternate platform, that will require purchasing an explicit license. In that case, please fill out the [contact form](/faq#contact) below with details about what you are looking for.
...
As a forewarning, I'm trying to keep talks to a mininum this year, so just know that I have to decline most requests coming in. Nevertheless, feel free to fill in the [contact form](/faq#contact) below with details, including the date, location and whether you have any estimated speaking fee in mind.
