...
That would be wonderful, thank you! My friend Ben Eater and I are building a system to make it easier for communities to contribute translations to YouTube channels they follow: [Criblate](https://criblate.com/).

There, you can review a translation, whose first pass was often machine generated, and once your review and edit is approved it will be added as the official subtitles for that language on YouTube with attribution to you.

Our plan is to use these translations for dubs as well. A new-ish feature on YouTube lets me add alternate audio tracks to videos, but creating dubs and syncing the timings reliably takes _significantly_ longer than people expect. We'll be working on tooling to streamline the process, and if you're interested dubbing and being part of early experiments, feel free to let me know via the [general contact form](/contact).

In the past, my policy with dubbing was that anyone who was interested was welcome to give it a go, and I'd upload it to an official translation channel. In light of the ability to add alternate audio tracks to the main videos, moving forward it will be better to consolidate translations on the main channel when possible.
