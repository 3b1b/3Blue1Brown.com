...
If you wish to create a new dubbed video to be uploaded to an official translation channel, say because exactly matching the timing is a challenge or because you also wish to translate words on the screen, read the further information below.
...
Maybe. While I do occasionally speak at schools and corporate events, it's worth mentioning that the main focus will always be the videos, so I try to keep talks to a minimum. Feel free to fill out the speaking request form below.
