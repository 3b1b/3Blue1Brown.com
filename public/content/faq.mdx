...
Subtitles are the easiest form of contribution, and they will show up on the main channel videos. In this [github repository](https://github.com/3b1b/captions), I keep track of the captions for videos. Many of them are AI-translations, and so could probably benefit from a native speaker to look it over and ensure it's natural. To make contributions or edits, feel free to submit a pull request to that repository. Once the pull request is merged, the subtitles will be uploaded to the relevant video.
