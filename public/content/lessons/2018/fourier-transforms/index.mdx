...
So this little mathematical machine does exactly what we wanted: it pulls out the constituent frequencies from a provided waveform, essentially unmixing a mixed bucket of paint. The applet below allows you to change the input wave form by separating the frequencies <Tooltip content="Only 5 frequencies between 0Hz and 4.4Hz will be shown.">by commas</Tooltip>.
