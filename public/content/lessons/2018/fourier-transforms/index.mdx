...
- Text Adaption by James Schloss & River Way
---
...
will provide the function of $g$ at time $t$ and also the point along the circle $e^{-2\pi i f t}$. This is almost precisely the same as the winding machine we created before! Now we just need some sort of formula to capture the motion of the center of mass.
