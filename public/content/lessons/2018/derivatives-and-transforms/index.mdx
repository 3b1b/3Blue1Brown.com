...
Here, notice that the inputs in a little neighborhood around, say, $-2$, don't just get stretch out, they also get flipped around. 

<Figure image="transform_10.png" video="transform_10.mp4" show ="video"/>

Specifically, the action on such a neighborhood looks dmore and more like multiplying by $-4$ the closer you zoom in. This is what it looks like for a function to have a negative derivative.
...
Take a look at the diagram above...Fill in answer here
