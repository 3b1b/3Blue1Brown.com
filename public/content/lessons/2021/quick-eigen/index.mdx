...
3-\lambda & 1 \\
4 & 1-\lambda
\end{array}\right]\right)=(3-\lambda)(1-\lambda)-(1)(4)
$$
...
Likewise, most linear algebra students are well-practiced at finding the determinant, which in this case is $48 - 8$, so you know the product of our two eigenvalues is $40$.
...
This is an oddly specific trick, but it's something that could be helpful in college, so if you know any students you think might benefit from this, consider sharing it with them.
