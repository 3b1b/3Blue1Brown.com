...
<Center>
  <Clickable
    link="https://forms.gle/iUsWBMZ5rTP4NgQA6"
    text="Submit your entry here by August 22"
    design="rounded"
  />
</Center>
...
> _Note: Since announcing the contest, Brilliant came in to offer a total of $5,000 in cash prizes to be split among top entries. We'll split it evenly, allocating $1,000 each to the five entries selected to be featured in a video_

For the rest, we will put together a playlist of the video entries, and have a list of submissions on the 3blue1brown website. (This only applies to good faith submissions, anything irrelevant or offensive would not be included).

To trade tips, share partial progress, and otherwise interact with others involved, join the [discord](https://discord.gg/SRTErdZ9).
...
## Other questions?
We'll update this page with more FAQs as they come in.  Feel free to ask on [Reddit](https://www.reddit.com/r/3Blue1Brown/)
