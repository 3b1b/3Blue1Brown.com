...
<!-- TODO: Communicate rotation in this image -->
<Figure image="constant_1.jpeg" />

Then there will be a vector rotating 1 cycle every second which we write as $e^{2 \pi i t}$.

<!-- TODO: Communicate rotation in this image, and get of the little box showing the input range with t -->
...
<!-- TODO: Communicate rotation in this image, and perhaps offer an animated version -->
...
<!-- TODO: Maybe replace the 0.99 inside "sum" here with the variable t -->
