...
<Figure video="intricacy_1.mp4" image="intricacy_1.png" show="video" />
...
<Figure video="intricacy_2.mp4" image="intricacy_2.png" show="video" />
...
<Figure video="fourier_intro_2.mp4" image="fourier_intro_2.png" show="video" />
...
<Figure video="heat_1.mp4" image="heat_1.png" />
...
<Figure video="heat_2.mp4" image="heat_2.png" />
...
<Figure image="complex_1.png" video="complex_1.mp4" show="video" />
...
<Figure image="complex_4.png" video="complex_4.mp4" show="video" />
...
<Figure image="complex_5.png" video="complex_5.mp4" show="video" />
...
<Figure image="complex_6.png" video="complex_6.mp4" show="video" />
...
<Figure image="constant_5.png" />

For example, if we wanted that constant vector not to be at the number 1, but to have a length of 0.5, we’d scale it by 0.5. If we wanted the vector rotating at one cycle per second to start off at an angle of $45^{\circ}$, we’d multiply it by a complex number which has the effect of rotating it by that much, which you might write as $e^{\frac{\pi}{4} i}$. If it’s initial length needed to be 0.3, the coefficient would be 0.3 times that amount.
...
<Figure image="practice_1.png" video="practice_1.mp4" show="video" />
...
<Figure image="step_2.png" video="step_2.mp4" show="video" />
...
<Figure image="step_3.png" video="step_3.mp4" show="video" />
