...
<Figure image="3_img.png" video="3_img.mp4" show="video" />
...
<Figure image="4_outer.png" video="4_outer.mp4" show="video" />

However, if we put it inside that triangle, then it looks like our windmill never hits it.

<Figure image="4_never.png" video="4_never.mp4" show="video" />
