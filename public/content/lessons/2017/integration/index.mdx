...
So in our current situation, where all we know is the velocity function, it should make sense that finding a distance vs. time function $s(t)$ comes down to asking what function has a derivative $t(8-t)$. This is often described as finding the antiderivative of a function.

<Figure
  image="figures/derivative-antiderivative.light.svg" 
/>

<!-- question: show an example of a antiderivative of 2t on the left and show another cycle on the right with an the unknown s(t) function-->

And indeed, that's what we'll end up doing, and you could even pause and try that right now for the function $v(t)=t(8-t)$. But first, I want to spend the bulk of this article showing how this question is related to finding an area bounded by the velocity graph, because that helps to build an intuition for a whole class of what are called "integral problems" in math and science.

<Figure
  image="figures/velocity-area-under-curve.png" 
/>

TODO: highlight area under the graph. Note, in the video it shows a riemann sum approximation getting better and better, but maybe ok to just highlight area here?
...
TODO: velocity is constantly changing
...
TODO: Show approximate calculate of distance traveled, compare with actual distance traveled.
...
TODO: Show different approximations with finer and finer intervals

TODO: Practice problem, breaking at a constant rate

TODO: Future practice problem (inflection points). Have you ever been in someone's car where their driving is jerky...
...
Consider one of these intervals, like the one between $t=1$, and 1.25. In reality, the car speeds up from 7 m/s to about 8.4 m/s during that time, which you can find by plugging in $t = 1$ and 1.25 to the equation for velocity.

<Figure
  image="figures/velocity-riemann-sum-36-higlight-1.dark.svg" 
/>

We want to approximate the car's motion as if its velocity was constant on this interval. Again, the reason for doing that is that we don't really know how to handle anything other than constant velocity situations. <!-- TODO: Now, you may notice a couple improvements of this approximation right away like averaging the two points, using the right point, or even a trapezoid. (if the constant breaking problem is used above, then some note about how the different approximation method doesn't matter in the end)--> You could choose this constant to be anything between 7 and 8.4, it doesn't really matter.
...
TODO: illustrate n=8, n=36, n=80, n=200?
...
<Figure
  image="figures/approximation-t-1.png" 
/>

TODO: Visualize Riemann sum approximation.
...
<Figure
  image="figures/velocity-integral.light.svg" 
/>
