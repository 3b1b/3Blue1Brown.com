...
We can check our work using the power rule. The expression $\frac{1}{x}$ is the same as $x^{-1}$ and we can drop the $-1$ down in front and subracting one from the exponent, giving us the same answer.
