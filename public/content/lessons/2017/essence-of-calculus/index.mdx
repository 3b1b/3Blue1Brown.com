...
<Question
  ...
  answer={1}
>
  In physics, position, velocity and acceleration are all related together. Position can be modeled as the area under the graph of veloctiy and velocity can be modeled as the area under the graph of acceleration.
</Question>
