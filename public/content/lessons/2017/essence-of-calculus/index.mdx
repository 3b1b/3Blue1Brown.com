...
<Question
  ...
  answer={3}
  explanation="The area of the ring can be approximated as the area of a rectangle with a length of $2 \pi r$ and a height of $dr$."
/>
...
<Question
  ...
  choice4="$\frac{3}{5} \pi$"
  answer={4}
  explanation="Substituting the value of the inner radius $0.3$ into the formula for the circumference of a circle $2 \pi r$ calculates the height of the rectangle to be $\frac{3}{5} \pi$."
/>
...
<Question
  ...
  choice2="No"
  answer={1}
  explanation="In physics, position, velocity and acceleration are all related together. Position can be modeled as the area under the graph of veloctiy and velocity can be modeled as the area under the graph of acceleration."
/>
