...
This happens to be the expression that pops out if you unravel the definition for the derivative of $x^3$ at $x=2$, but let’s just think of it as any old function with an input $h$. Its graph is this nice continuous looking parabola.
...
$$
\lim _{h \rightarrow 0} \frac{(2+h)^{3}-2^{3}}{h} = 12
$$

<Question
  question="What happens if we use algebra to check our result and does it confirm our answer of $12$?"
  choice1="1"
  choice2="1"
  choice3="1"
  choice4="1"
