...
However, let’s just think of it as any old function with an input $h$. Its graph is this nice continuous looking parabola.

<Figure
  image="figures/example-limit.svg" 
/>

But actually, if you think about what’s going at $h=0$, plugging that in you’d get $0/0$, which is not defined. So really, this graph has a hole at that point. You have to exaggerate to draw that hole, often with a little empty circle like this, but keep in mind the function is perfectly well-defined for inputs as close to $0$ as you want.
