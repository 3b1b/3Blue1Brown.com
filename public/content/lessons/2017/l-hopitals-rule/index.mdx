...
So far this is all pretty theory heavy; limits being used to formally define the derivative, then epsilons and deltas being used to rigorously define limits themselves. So, in this lesson,let’s finish off our dive into limits trick for actually computing limits.
...
One explanation is that no matter how small the value $dx$ is the fraction formed by the two nudges 

, since these nudges behave like the tangent lines at $x=0$, 
