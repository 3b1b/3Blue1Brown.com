...
<Figure
  image="figure-3.00-question-answer.svg" 
/>
...
This idea of $\frac{ds}{dt}$, a tiny change in the value of the function $s$ divided by a tiny change in the input $t$, is *almost* what the derivative is.
...
<Question
  ...
  answer={2}
  explanation="A negative tangent line means that the slope is negative and the car is going backwards."
/>
