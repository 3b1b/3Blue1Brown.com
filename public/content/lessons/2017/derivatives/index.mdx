...
<Figure
  image="figure-1.43,1.50-wide.svg"
...
<Figure
  image="figure-2.06-2.20-wide.svg"
...
<Figure
  image="figure-3.00-question-wide.svg" 
/>
...
<Figure
  image="figure-3.00-answer-wide.svg" 
/>
...
<Question
  ...
  choice4="$9 \frac{m}{s}$"
  answer={3}
  explanation="The velocity of the car is calculated by substiting $t=1$ into the derivative function $\frac{d s}{d t}(1)=3(1)^{2} = 3$."
/>
