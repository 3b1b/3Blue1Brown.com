...
<Question
  question="What is the inverse matrix for a $180^\circ$ rotation? $\begin{bmatrix}0&-1\\-1&0\end{bmatrix}$"
  choice1="$\begin{bmatrix}0&-1\\-1&0\end{bmatrix}$"
...
<Question
  question="Does $A^{-1}$ exist when $A=\begin{bmatrix}3&-1\\-9&3$?"
