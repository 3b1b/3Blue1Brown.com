...
<Center>
  <Clickable
    link="/blog/book-recommendations"
    text="Book recommendations"
    design="rounded"
  />
  <Clickable
    link="/blog/recommendations"
    text="Recommended sites/channels"
    design="rounded"
  />
</Center>
...
<Accordion title="Recruiting inquiry" preserveInnerState={true}>

Use this form _if you represent a company_ that wishes to recruit through 3Blue1Brown.
