...
wordmark: /content/talent/janestreet/wordmark.svg
hide_header: true
...
On our Machine Learning team, you'll build the deep learning models that power our trading strategies, supported by tens of thousands of high-end GPUs. Financial markets pose unique challenges for machine learning: extreme noise, nonstationarity, and a competitive multi-agent environment. Our researchers keep up with the latest developments in the field and pursue novel research approaches unique to Jane Street.
