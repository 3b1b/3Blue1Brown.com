...
featured_quote: "The decision everybody made independently was that the time we're in right now is too unique to pass up. Let's knock this one out of the park because it is the highest delta you could possibly have in the world of technology right now."
---

<Section width="normal">

<VideoShowcase videos={[
  { title: "Meet our leadership", url: "https://youtu.be/-pZ3vD0r8a0" },
  { title: "See how people use Devin", url: "https://www.youtube.com/watch?v=AHJ-_uPuJqs" },
]} />

<Accordion title="More about us on the web">

- [Cloud Agents and the Cognition Platform Play, Why We Win the Enterprise](https://x.com/dabit3/status/2020564900834111518)
- [I Spent December Seeing the Future. Then I Joined It.](https://x.com/dabit3/status/2019127306963546452?s=20) (Article from new Cognition team member, Nader)
...
- [Eventually, The Future Comes](https://x.com/ScottWu46/status/2026350958213787903) (short article from Scott Wu)
...
- [Our Use Case Library](https://docs.devin.ai/use-cases) (some of the different ways you can leverage Devin)
- [Our Customer Stories Page](https://devin.ai/customers) (some of the different ways companies leverage Devin)
...
In that first visit, the sheer concentration of both talent and hustle is unreal. It's something like the software engineering equivalent of a close-knit team of athletes training for the Olympics.

More recently, I visited in the context of this partnership with 3b1b, and was pleased to see that through their growth since my first visit (gone are the days of all working from one house), the talent concentration remains as dense as ever.
