<Section dark={true}>
  ...
  <HomepageFeaturedContent title="Animated math" show_latest_video={false}>
    <HomepageFeaturedItem
      lesson="holograms"
      caption="How are holograms possible?"
      youtube_id="EmKQsSDlaa4"
      link="http://youtu.be/EmKQsSDlaa4"
    />
    <HomepageFeaturedItem
