<Section dark={true}>
  <HomepageFeaturedContent
    ...
    >
    <HomepageFeaturedItem lesson="olympiad-level-counting" caption="A counting problem that's about the journey and not so much about the destination.">
      <HomepageFeaturedVideo src="olympiad-level-counting.mp4" />
