<Section dark={true}>
  <HomepageFeaturedContent
    title="Animated math"
    subtitle="3Blue1Brown is primarily a YouTube channel, but here you can find written and interactive adaptations of the lessons."
    >
    ...
    <HomepageFeaturedItem lesson="prime-spirals" caption="Learn why polar plots of primes form these spirals">
      <HomepageFeaturedVideo src="/featured-content/prime-spirals.mp4" />
    </HomepageFeaturedItem>
