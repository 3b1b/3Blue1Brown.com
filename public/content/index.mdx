...
This funding also helps to support side projects associated with the channel, such as the written and interactive adaptations of many videos on this website, or the Summer of Math Exposition. The open-source projec manim underlying the channel could be considered another such side project. However, it's worth noting that the most user-friendly version of it is the community edition, which is maintained by a group outside of 3b1b.
