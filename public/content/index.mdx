<Section dark={true}>
  ...
  >
    <HomepageFeaturedItem
      lesson="wordle"
      caption="New video! Solving Wordle using information theory"
    >
      <a href="/lessons/wordle">
        <Image
          alt="Wordle Lesson Photo"
          aRatio="16 / 9"
          priority
          src="https://img.youtube.com/vi/v68zYyaEmEA/maxresdefault.jpg"
        />
      </a>
    </HomepageFeaturedItem>
    <HomepageFeaturedItem
    ...
    <HomepageFeaturedItem lesson="bitcoin" caption="Learn how bitcoin works">
      <Interactive filename="lessons/2017/bitcoin/live-transactions-interactive/index" />
    </HomepageFeaturedItem>
    <HomepageFeaturedItem
      lesson="sphere-area"
    ...
    <HomepageFeaturedItem lesson="" caption="">
      <Image
        src="featured-content/pi-comment.svg"
        width="465px"
        height="290px"
      />
    </HomepageFeaturedItem>
...
<Portrait image="images/home/patreon-logo.svg" alt="Patreon Logo" />
